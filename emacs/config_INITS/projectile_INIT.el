...
;; Workspaces (I have perspective in its own INIT now)
...
;; end new with perspective

;; this is from https://raw.githubusercontent.com/kaushalmodi/.emacs.d/master/setup-files/setup-projectile.el
...
(use-package projectile
  ...
  (progn
    ...
    ;; AE hit RETURN to just open dired at project top level
    (setq projectile-find-dir-includes-top-level t)
    ;; above didn't work as advertised

    ;; from https://endlessparentheses.com/improving-projectile-with-extra-commands.html
    (setq projectile-switch-project-action
	  #'projectile-commander)
    ;; above gives some hard to understand list of keystrokes
    ;; making "d" open root in dired (from above reference)
    (def-projectile-commander-method ?d
      "Open project root in dired."
      (projectile-dired))
    ;; well .. that didn't seem to work
    
    ;; end projectile-commander bit
