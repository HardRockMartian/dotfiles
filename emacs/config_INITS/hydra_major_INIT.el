;; this mode is from https://github.com/jerrypnz/major-mode-hydra.el
...
;; AE not sure what this example does, but I do like helpful Hydras
;; well ... it seems to do in Hydra mode what I think I'd eventually
;; like F1 to do
...
;; trying some more from https://github.com/abo-abo/hydra/wiki/Hydras-by-Topic
...
;; AE: this ibuffer bit doesn't seem very useful in ibuffer-sidebar
;; maybe I'm just new to the system
...
;; AE this is from https://github.com/alphapapa/unpackaged.el/blob/master/unpackaged.el
;; NOTE: author cites conflicts with ediff 
